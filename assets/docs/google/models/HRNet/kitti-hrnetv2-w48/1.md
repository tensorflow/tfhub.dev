# Module google/HRNet/kitti-hrnetv2-w48/1

HRNet based model trained on the semantic segmentation dataset KITTI [4].
...
model = hub.load('https://tfhub.dev/google/HRNet/kitti-hrnetv2-w48/1')

ds = tfds.load('scene_parse150', split='train', with_info=False)
img = next(iter(ds))['image']
img = tf.cast([img], tf.float32)/255.0

# Predictions will have shape (batch_size, h, w, output_classes=30+1)
...
[4] Alhaija, H., Mustikovela, S., Mescheder, L., Geiger, A., Rother, C.: Augmented
reality meets computer vision : Efficient data generation for urban driving scenes.
IJCV (2018).
