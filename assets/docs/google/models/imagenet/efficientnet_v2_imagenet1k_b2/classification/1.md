# Module google/imagenet/efficientnet_v2_imagenet1k_b2/classification/1

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet V2 with input size 260x260. 
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_b2/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/feature_vector/1)
instead, and save the space occupied by the classification layer.


## Training

The checkpoint exported into this model was `EffNetV2-B2 for ImageNet1k` downloaded
from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/classification/1")
])
...
`height` x `width` = 260 x 260 pixels.
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/classification/1", trainable=True)
```
