...
It uses L=4 hidden layers (i.e., Transformer blocks), a hidden size of H=256,
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-4_H-256_A-4/1")
