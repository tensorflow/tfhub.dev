# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_b1/feature_vector/2
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_b1/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_b1/classification/2)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_b1/feature_vector/2",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_b1/feature_vector/2", trainable=True)
```
