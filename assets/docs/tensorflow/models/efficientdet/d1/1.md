# Module tensorflow/efficientdet/d1/1

EfficientDet Object detection model (SSD with EfficientNet-b1 + BiFPN feature
...
SSD with EfficientNet-b1 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d1). See
...
EfficientNet-b1 checkpoint. Model created using the
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 38.4  | Boxes
