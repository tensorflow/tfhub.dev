# Module tensorflow/efficientdet/d4/1

EfficientDet Object detection model (SSD with EfficientNet-b4 + BiFPN feature
...
SSD with EfficientNet-b4 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d4). See
...
EfficientNet-b4 checkpoint. Model created using the
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 48.5  | Boxes
