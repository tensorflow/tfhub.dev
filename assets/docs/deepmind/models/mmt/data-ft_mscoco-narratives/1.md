# Module deepmind/mmt/data-ft_mscoco-narratives/1
...
This model is our `data-ft_mscoco-narratives` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data-ft_mscoco-narratives/1')
```
