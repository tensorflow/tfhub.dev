# Module deepmind/mmt/architecture-ft_single-stream/1
...
This model is our `architecture-ft_single-stream` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture-ft_single-stream/1')
```
