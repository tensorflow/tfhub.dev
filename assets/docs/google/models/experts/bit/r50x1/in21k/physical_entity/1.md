# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;physical_entity/1
BiT-m R50x1 fine-tuned on the ImageNet "physical_entity" subtree.
...
on the subtree "physical_entity" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/physical_entity/1")
...
This model was further trained on the "physical_entity" subtree of Imagenet and
