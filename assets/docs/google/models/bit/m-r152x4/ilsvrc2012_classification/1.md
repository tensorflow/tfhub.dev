# Module google/bit/m-r152x4/ilsvrc2012_classification/1

ImageNet-1k (ILSVRC-2012) classification with the BiT-M model.
...
```python
module = hub.KerasLayer("https://tfhub.dev/google/bit/m-r152x4/ilsvrc2012_classification/1")
...
[module that extracts feature vectors](https://tfhub.dev/google/bit/m-r152x4/1)
instead.
...
[specific module for doing so](https://tfhub.dev/google/bit/m-r152x4/1).

In addition, we also provided a module
[fine-tuned on the ImageNet-21k](https://tfhub.dev/google/bit/m-r152x4/imagenet21k_classification/1)
