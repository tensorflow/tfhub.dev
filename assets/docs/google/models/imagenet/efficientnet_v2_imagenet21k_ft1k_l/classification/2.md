# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_l/classification/2

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2
with input size 480x480. Fine-tuned on ImageNet1K.
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_l/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_l/feature_vector/2)
instead, and save the space occupied by the classification layer.

## Training

The checkpoint exported into this model was `EffNetV2-L for ImageNet21k
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_l/classification/2")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_l/classification/2", trainable=True)
```
