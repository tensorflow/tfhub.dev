...
This model is a Vision Transformer of type B-8 [1, 2] pre-trained on the ImageNet-21k dataset [3] and fine-tuned on the
...
[3] [ImageNet database](https://www.image-net.org/)  
