# Module google/bit/m-r50x3/ilsvrc2012_classification/1

ImageNet-1k (ILSVRC-2012) classification with the BiT-M R50x3 model.
...
```python
module = hub.KerasLayer("https://tfhub.dev/google/bit/m-r50x3/ilsvrc2012_classification/1")
...
[fine-tuned on the ImageNet-21k](https://tfhub.dev/google/bit/m-r50x3/imagenet21k_classification/1)
