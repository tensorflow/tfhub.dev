# Module google/HRNet/bdd-hrnetv2-w48/1

HRNet based model trained on the semantic segmentation dataset Berkeley Deep Drive (BDD) [4].
...
model = hub.load('https://tfhub.dev/google/HRNet/bdd-hrnetv2-w48/1')

ds = tfds.load('scene_parse150', split='train', with_info=False)
img = next(iter(ds))['image']
img = tf.cast([img], tf.float32)/255.0

# Predictions will have shape (batch_size, h, w, output_classes=20+1)
...
[4] Yu, F., Chen, H., Wang, X., Xian, W., Chen, Y., Liu, F., Madhavan, V., Darrell,
