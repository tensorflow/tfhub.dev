# Module tensorflow/efficientdet/d3/1

EfficientDet Object detection model (SSD with EfficientNet-b3 + BiFPN feature
...
SSD with EfficientNet-b3 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d3). See
...
EfficientNet-b3 checkpoint. Model created using the
...
detector = hub.load("https://tfhub.dev/tensorflow/efficientdet/d3/1")
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 45.4  | Boxes
