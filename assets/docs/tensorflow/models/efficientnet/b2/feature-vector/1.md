# Module tensorflow/efficientnet/b2/feature-vector/1
...
[https://tfhub.dev/tensorflow/efficientnet/b2/classification/1](https://tfhub.dev/tensorflow/efficientnet/b2/classification/1)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/tensorflow/efficientnet/b2/feature-vector/1",
...
to match the model training input, which is `height` x `width` = 260 x 260
