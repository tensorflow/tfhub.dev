...
Fine-tunable Video Swin Transformer model pre-trained on the ImageNet-22K dataset and was then fine-tuned on Kinetics 600(22k) dataset.
...
## Overview
This model is a Video Swin Transformer [1] pre-trained on the ImageNet-22K dataset and was then fine-tuned on Kinetics 600(22k) dataset. You can find the complete
