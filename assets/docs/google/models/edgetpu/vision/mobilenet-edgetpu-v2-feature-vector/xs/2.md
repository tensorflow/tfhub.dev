# Module google/edgetpu/vision/mobilenet-edgetpu-v2-feature-vector/xs/2
...
The x-small version (XS) model contains 4.9M parameters. For ImageNet1K dataset,
the model achieves **75.79% top-1 accuracy** with **0.82 ms** latency running on
Pixel 6
...
[here](https://tfhub.dev/google/edgetpu/vision/mobilenet-edgetpu-v2/xs/1).
...
hub_layer = hub.KerasLayer(
    'https://tfhub.dev/google/edgetpu/vision/mobilenet-edgetpu-v2-feature-vector/xs/2',
    trainable=False)
