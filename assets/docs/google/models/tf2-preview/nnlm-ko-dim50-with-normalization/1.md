# Module google/&zwnj;tf2-preview/&zwnj;nnlm-ko-dim50-with-normalization/1
...
TF2.0 functionalities. It is based on [https://tfhub.dev/google/nnlm-ko-dim50/1](https://tfhub.dev/google/nnlm-ko-dim50/1).
...
embed = hub.load("https://tfhub.dev/google/tf2-preview/nnlm-ko-dim50-with-normalization/1")
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/tf2-preview/nnlm-ko-dim50-with-normalization/1", output_shape=[50], 
