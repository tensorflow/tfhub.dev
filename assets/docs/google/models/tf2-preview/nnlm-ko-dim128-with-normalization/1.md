# Module google/&zwnj;tf2-preview/&zwnj;nnlm-ko-dim128-with-normalization/1
...
embed = hub.load("https://tfhub.dev/google/tf2-preview/nnlm-ko-dim128-with-normalization/1")
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/tf2-preview/nnlm-ko-dim128-with-normalization/1", output_shape=[128], 
