# Module tensorflow/small_bert/bert_en_uncased_L-8_H-128_A-2/1
Smaller BERT model.
...
It uses L=8 hidden layers (i.e., Transformer blocks), a hidden size of H=128,
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-8_H-128_A-2/1")
