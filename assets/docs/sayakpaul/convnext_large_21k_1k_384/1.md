# Module sayakpaul/convnext_large_21k_1k_384/1

ConvNeXt model pre-trained on the ImageNet-21k dataset and was then fine-tuned on the ImageNet-1k dataset.

<!-- asset-path: https://storage.googleapis.com/convnext/saved_models/tars/convnext_large_21k_1k_384.tar.gz  -->
...
model = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/sayakpaul/convnext_large_21k_1k_384/1", trainable=False)
])
