# Module google/imagenet/efficientnet_v2_imagenet1k_s/classification/1

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet V2 with input size 384x384. 
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/1)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/classification/1", trainable=True)
```
