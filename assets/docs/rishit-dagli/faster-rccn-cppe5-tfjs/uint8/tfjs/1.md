# Tfjs rishit-dagli/faster-rccn-cppe5-tfjs/uint8/tfjs/1
...
```js
const model = await tf.loadGraphModel("https://tfhub.dev/rishit-dagli/faster-rccn-cppe5-tfjs/uint8/tfjs/1")
```
