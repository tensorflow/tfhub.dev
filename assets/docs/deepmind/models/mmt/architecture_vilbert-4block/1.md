# Module deepmind/mmt/architecture_vilbert-4block/1
...
This model is our `architecture_vilbert-4block` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_vilbert-4block/1')
```
