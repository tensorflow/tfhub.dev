# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/2

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2
with input size 384x384. Fine-tuned on ImageNet1K.
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/2)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/2")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/2", trainable=True)
```
