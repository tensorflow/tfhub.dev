# Module deepmind/mmt/architecture_mixed-modality/1
...
This model is our `architecture_mixed-modality` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_mixed-modality/1')
```
