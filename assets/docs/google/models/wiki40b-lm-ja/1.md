# Module google/wiki40b-lm-ja/1
Embeddings and negative log likelihood from a language model
trained on Japanese from Wiki40B dataset with sentence-piece
vocabulary size 32k.
...
This specific module is trained on Japanese available in Wiki40B dataset.
It is trained using a 12 layers Transformer XL model [2]. The input to the
module is variable length text in Japanese, and the output is a 768
