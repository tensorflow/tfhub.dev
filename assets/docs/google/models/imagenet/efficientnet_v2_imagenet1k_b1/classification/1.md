# Module google/imagenet/efficientnet_v2_imagenet1k_b1/classification/1

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet V2 with input size 240x240. 
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_b1/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b1/feature_vector/1)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b1/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b1/classification/1", trainable=True)
```
