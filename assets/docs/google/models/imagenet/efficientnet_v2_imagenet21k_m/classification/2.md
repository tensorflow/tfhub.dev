# Module google/imagenet/efficientnet_v2_imagenet21k_m/classification/2

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2
with input size 480x480.
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/2)
instead, and save the space occupied by the classification layer.

## Training

The checkpoint exported into this model was `EffNetV2-M for ImageNet21k`
downloaded from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/classification/2")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/classification/2", trainable=True)
```
