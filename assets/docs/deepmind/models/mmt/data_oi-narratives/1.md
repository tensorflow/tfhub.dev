# Module deepmind/mmt/data_oi-narratives/1
...
This model is our `data_oi-narratives` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data_oi-narratives/1')
```
