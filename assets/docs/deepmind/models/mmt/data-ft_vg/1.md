# Module deepmind/mmt/data-ft_vg/1
...
This model is our `data-ft_vg` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data-ft_vg/1')
```
