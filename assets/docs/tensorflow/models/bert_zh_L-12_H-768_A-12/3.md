# Module tensorflow/bert_zh_L-12_H-768_A-12/3
...
and A=12 attention heads. For other model sizes, see the
...
[https://tfhub.dev/tensorflow/bert_zh_preprocess/3](https://tfhub.dev/tensorflow/bert_zh_preprocess/3)
...
The [preprocessor documentation](https://tfhub.dev/tensorflow/bert_zh_preprocess/3)
...
(See the [preprocessor model page](https://tfhub.dev/tensorflow/bert_zh_preprocess/3) for how to get the
...
encoder = hub.load("https://tfhub.dev/tensorflow/bert_zh_L-12_H-768_A-12/3")
