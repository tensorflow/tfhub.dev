# Module google/HRNet/isaid-hrnetv2-w48/1

HRNet based model trained on the semantic segmentation dataset iSAID [4].
...
model = hub.load('https://tfhub.dev/google/HRNet/isaid-hrnetv2-w48/1')

ds = tfds.load('scene_parse150', split='train', with_info=False)
img = next(iter(ds))['image']
img = tf.cast([img], tf.float32)/255.0

# Predictions will have shape (batch_size, h, w, output_classes=16+1)
...
[4] Waqas Zamir, S., Arora, A., Gupta, A., Khan, S., Sun, G., Shahbaz Khan, F.,
Zhu, F., Shao, L., Xia, G.S., Bai, X.: isaid: A large-scale dataset for instance
segmentation in aerial images. In: CVPR Workshops (2019).
