# Module deepmind/mmt/data_cc-with-bert/1
...
This model is our `data_cc-with-bert` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data_cc-with-bert/1')
```
