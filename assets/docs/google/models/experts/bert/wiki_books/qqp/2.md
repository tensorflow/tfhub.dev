# Module google/experts/bert/wiki_books/qqp/2
...
https://tfhub.dev/google/experts/bert/wiki_books/1 and fine-tuned on QQP[5] and
...
bert = hub.load('https://tfhub.dev/google/experts/bert/wiki_books/qqp/2')
