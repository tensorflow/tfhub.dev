# Module google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/2
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_m/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/classification/2)
instead.
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/2", trainable=True)
```
