# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/1

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2 with input size 384x384. Fine-tuned on ImageNet1K.
...
<!-- colab: https://colab.research.google.com/github/tensorflow/docs/blob/master/site/en/hub/tutorials/image_classification.ipynb -->
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/1)
instead, and save the space occupied by the classification layer.


## Training

The checkpoint exported into this model was `EffNetV2-S for ImageNet21k fine-tuned on ImageNet1K` downloaded
from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/1", trainable=True)
```
