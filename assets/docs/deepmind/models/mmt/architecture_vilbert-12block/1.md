# Module deepmind/mmt/architecture_vilbert-12block/1
...
This model is our `architecture_vilbert-12block` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_vilbert-12block/1')
```
