# Module deepmind/mmt/architecture-ft_image-q-24/1
...
This model is our `architecture-ft_image-q-24` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture-ft_image-q-24/1')
```
