# Module google/&zwnj;nnlm-ko-dim128-with-normalization/2
...
embed = hub.load("https://tfhub.dev/google/nnlm-ko-dim128-with-normalization/2")
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/nnlm-ko-dim128-with-normalization/2",
