# Module deepmind/mmt/architecture_language-q-24/1
...
This model is our `architecture_language-q-24` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_language-q-24/1')
```
