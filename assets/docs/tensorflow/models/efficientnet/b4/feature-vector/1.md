# Module tensorflow/efficientnet/b4/feature-vector/1
...
[https://tfhub.dev/tensorflow/efficientnet/b4/classification/1](https://tfhub.dev/tensorflow/efficientnet/b4/classification/1)
instead.
...
to match the model training input, which is `height` x `width` = 380 x 380
