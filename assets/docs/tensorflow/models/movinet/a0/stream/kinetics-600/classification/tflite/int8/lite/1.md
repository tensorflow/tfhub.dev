# Lite tensorflow/movinet/a0/stream/kinetics-600/classification/tflite/int8/1

MoViNets (Mobile Video Networks) for efficient video classification with MoViNet-A0-Stream, TF Lite quantized (int8).
...
First download the file movinet_a0_stream_k600_int8.tflite to your local path. Then run the
following code.
