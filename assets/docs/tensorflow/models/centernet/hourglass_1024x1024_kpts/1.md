# Module tensorflow/centernet/hourglass_1024x1024_kpts/1

CenterNet Object and Keypoints detection model with the Hourglass backbone,
...
detector = hub.load("https://tfhub.dev/tensorflow/centernet/hourglass_1024x1024_kpts/1")
...
------------------------- | --------- | ---------------
mAP on COCO 2017 test set | 42.8/64.5 | Boxes/Keypoints
