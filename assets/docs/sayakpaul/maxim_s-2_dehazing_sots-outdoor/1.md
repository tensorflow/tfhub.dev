# Module sayakpaul/maxim_s-2_dehazing_sots-outdoor/1

MAXIM model pre-trained on the sots-outdoor suitable for image dehazing.

<!-- asset-path: https://storage.googleapis.com/maxim-tf/tars/S-2_dehazing_sots-outdoor.tar.gz  -->
<!-- task: dehazing -->
...
This model is based on the MAXIM backbone [1] pre-trained on the sots-outdoor. You can use this
model for image dehazing. Please refer to the Colab Notebook linked on this page for more details.
