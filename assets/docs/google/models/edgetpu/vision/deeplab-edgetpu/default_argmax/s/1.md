# Module google/edgetpu/vision/deeplab-edgetpu/default_argmax/s/1
...
The small version (s) model contains 5.2M parameters, achieves **59.43% mIOU**
on ADE20K dataset with 32 classes. The latency on Pixel 6 Edge TPU is **5.9ms**.
