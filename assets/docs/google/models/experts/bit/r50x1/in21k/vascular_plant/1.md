# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;vascular_plant/1
BiT-m R50x1 fine-tuned on the ImageNet "vascular_plant" subtree.
...
on the subtree "vascular_plant of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/vascular_plant/1")
...
This model was further trained on the "vascular_plant" subtree of Imagenet and
