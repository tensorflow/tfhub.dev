# Module tensorflow/centernet/resnet101v1_fpn_512x512/1

CenterNet Object detection model with the ResNet-v1-101 backbone,
...
ResNet-V1-101 backbone trained on the [COCO 2017](https://cocodataset.org/)
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 34.2  | Boxes
