# Module google/bit/s-r50x3/1

Feature vector extraction with the BiT-S R50x3 model.
...
```python
module = hub.KerasLayer("https://tfhub.dev/google/bit/s-r50x3/1")
...
[a specific model](https://tfhub.dev/google/bit/s-r50x3/ilsvrc2012_classification/1)
for that.
