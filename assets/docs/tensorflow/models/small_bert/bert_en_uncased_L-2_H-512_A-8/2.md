# Module tensorflow/small_bert/bert_en_uncased_L-2_H-512_A-8/2
Smaller BERT model.
...
It uses L=2 hidden layers (i.e., Transformer blocks), a hidden size of H=512,
and A=8 attention heads. For other model sizes, see the
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-2_H-512_A-8/2")
