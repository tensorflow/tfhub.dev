# Module google/bit/s-r152x4/ilsvrc2012_classification/1

ImageNet-1k (ILSVRC-2012) classification with the BiT-S model.
...
```python
module = hub.KerasLayer("https://tfhub.dev/google/bit/s-r152x4/ilsvrc2012_classification/1")
...
[module that extracts feature vectors](https://tfhub.dev/google/bit/s-r152x4/1)
instead.
...
[specific module for doing so](https://tfhub.dev/google/bit/s-r152x4/1).
