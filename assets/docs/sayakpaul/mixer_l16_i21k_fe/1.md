# Module sayakpaul/mixer_l16_i21k_fe/1

MLP-Mixer L-16 feature extractor pre-trained on ImageNet-21k.
...
This model is an MLP-Mixer of type L-16 [1] pre-trained on the ImageNet-21k [2]. This is suitable for fine-tuning. Other models can be found from the [collection page](https://tfhub.dev/sayakpaul/collections/mlp-mixer/1).
