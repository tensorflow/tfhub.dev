# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;consumer_goods/1
BiT-m R50x1 fine-tuned on the ImageNet "consumer_goods" subtree.
...
on the subtree "consumer_goods" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/consumer_goods/1")
...
This model was further trained on the "consumer_goods" subtree of Imagenet and
