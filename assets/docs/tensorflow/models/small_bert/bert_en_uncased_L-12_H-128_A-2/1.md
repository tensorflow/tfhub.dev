# Module tensorflow/small_bert/bert_en_uncased_L-12_H-128_A-2/1
Smaller BERT model.
...
It uses L=12 hidden layers (i.e., Transformer blocks), a hidden size of H=128,
and A=2 attention heads. For other model sizes, see the
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-12_H-128_A-2/1")
