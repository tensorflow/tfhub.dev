# Lite tensorflow/mnasnet_1.0_96/1/metadata/1
TF Lite deployment of tensorflow/mnasnet_1.0_96/1.

<!-- asset-path: legacy -->
<!-- parent-model: tensorflow/mnasnet_1.0_96/1 -->
...
Image data: `ByteBuffer` sized `96 x 96 x 3 x PIXEL_DEPTH`, where
...
final int IMAGE_SIZE_X = 96;
final int IMAGE_SIZE_Y = 96;
