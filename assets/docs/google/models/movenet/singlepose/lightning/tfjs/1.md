# Tfjs google/movenet/singlepose/lightning/1

A deployment format of google/movenet/singlepose/lightning/1
...
<!-- parent-model: google/movenet/singlepose/lightning/1 -->
<!-- asset-path: internal -->
...
```javascript
tf.loadGraphModel("https://tfhub.dev/google/movenet/singlepose/lightning/tfjs/1", { fromTFHub: true });
```
