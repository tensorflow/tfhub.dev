# Module google/HRNet/city-hrnetv2-w48/1

HRNet based model trained on the semantic segmentation dataset CityScapes [4].
...
model = hub.load('https://tfhub.dev/google/HRNet/city-hrnetv2-w48/1')

ds = tfds.load('scene_parse150', split='train', with_info=False)
img = next(iter(ds))['image']
img = tf.cast([img], tf.float32)/255.0

# Predictions will have shape (batch_size, h, w, output_classes=33+1)
