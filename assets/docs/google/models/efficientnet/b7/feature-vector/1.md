# Module google/efficientnet/b7/feature-vector/1
...
to develop a mobile-size baseline network, named as `EfficientNet-B7`; Then, we
...
`EfficientNet-B7`. The default signature is used to get
[image feature vectors](https://www.tensorflow.org/hub/common_signatures/images#feature-vector).
If you want the full model including the classification it was originally
trained for, use module
[https://tfhub.dev/google/efficientnet/b7/classification/1](https://tfhub.dev/google/efficientnet/b7/classification/1)
instead.
...
```python
module = hub.Module("https://tfhub.dev/google/efficientnet/b7/feature-vector/1")
...
`height` x `width` = 600 x 600 pixels for this model. The input
