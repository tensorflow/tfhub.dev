# Module sayakpaul/convnext_base_21k_224/1

ConvNeXt model pre-trained on the ImageNet-21k dataset.

<!-- asset-path: https://storage.googleapis.com/convnext/saved_models/tars/convnext_base_21k_224.tar.gz  -->
...
model = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/sayakpaul/convnext_base_21k_224/1", trainable=False)
])
