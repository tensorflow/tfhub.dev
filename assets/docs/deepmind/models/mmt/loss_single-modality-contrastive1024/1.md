# Module deepmind/mmt/loss_single-modality-contrastive1024/1
...
This model is our `loss_single-modality-contrastive1024` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/loss_single-modality-contrastive1024/1')
```
