# Module google/imagenet/efficientnet_v2_imagenet21k_l/feature_vector/1
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_l/classification/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/classification/1)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/feature_vector/1",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/feature_vector/1", trainable=True)
```
