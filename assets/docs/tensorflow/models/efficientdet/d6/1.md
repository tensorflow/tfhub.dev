# Module tensorflow/efficientdet/d6/1

EfficientDet Object detection model (SSD with EfficientNet-b6 + BiFPN feature
...
SSD with EfficientNet-b6 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d6). See
...
EfficientNet-b6 checkpoint. Model created using the
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 50.5  | Boxes
