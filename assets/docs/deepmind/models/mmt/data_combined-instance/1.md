# Module deepmind/mmt/data_combined-instance/1
...
This model is our `data_combined-instance` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data_combined-instance/1')
```
