# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;invertebrate/1
BiT-m R50x1 fine-tuned on the ImageNet "invertebrate" subtree.
...
on the subtree "invertebrate" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/invertebrate/1")
...
This model was further trained on the "invertebrate" subtree of Imagenet and
