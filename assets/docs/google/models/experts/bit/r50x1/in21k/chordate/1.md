# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;chordate/1
BiT-m R50x1 fine-tuned on the ImageNet "chordate" subtree.
...
on the subtree "chordate" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/chordate/1")
...
This model was further trained on the "chordate" subtree of Imagenet and
