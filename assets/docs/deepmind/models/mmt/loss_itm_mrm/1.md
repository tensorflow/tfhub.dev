# Module deepmind/mmt/loss_itm_mrm/1
...
This model is our `loss_itm_mrm` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/loss_itm_mrm/1')
```
