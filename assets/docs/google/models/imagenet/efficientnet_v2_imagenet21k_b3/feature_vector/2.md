# Module google/imagenet/efficientnet_v2_imagenet21k_b3/feature_vector/2

Feature vectors of images with EfficientNet V2 with input size 300x300, trained
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_b3/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_b3/classification/2)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_b3/feature_vector/2",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_b3/feature_vector/2", trainable=True)
```
