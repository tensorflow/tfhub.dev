# Module sayakpaul/deit_tiny_distilled_patch16_224_fe/1

Fine-tunable model pre-trained on the ImageNet-1k dataset.

<!-- asset-path: https://storage.googleapis.com/deit-tf/tars/deit_tiny_distilled_patch16_224_fe.tar.gz  -->
