# Module deepmind/mmt/data-ft_combined-instance/1
...
This model is our `data-ft_combined-instance` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data-ft_combined-instance/1')
```
