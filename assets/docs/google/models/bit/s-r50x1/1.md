# Module google/bit/s-r50x1/1

Feature vector extraction with the BiT-S R50x1 model.
...
[a specific model](https://tfhub.dev/google/bit/s-r50x1/ilsvrc2012_classification/1)
for that.
