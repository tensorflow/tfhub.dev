# Module google/on_device_vision/classifier/landmarks_classifier_north_america_V1/1
...
*   `prediction:logits`: A vector of 99676 similarity scores, corresponding to
    ...
    landmark may appear multiple times; there are 18326 unique labels.
...
m = hub.Module('https://tfhub.dev/google/on_device_vision/classifier/landmarks_classifier_north_america_V1')
...
...
m = hub.KerasLayer('https://tfhub.dev/google/on_device_vision/classifier/landmarks_classifier_north_america_V1')
...
```
