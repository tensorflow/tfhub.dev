# Module google/&zwnj;tf2-preview/&zwnj;nnlm-id-dim128/1
...
embed = hub.load("https://tfhub.dev/google/tf2-preview/nnlm-id-dim128/1")
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/tf2-preview/nnlm-id-dim128/1", output_shape=[128], 
