# Module google/efficientnet/b5/classification/1

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet-B5.
...
`EfficientNet-B5`. The default signature is used to classify images. Besides,
...
```python
module = hub.Module("https://tfhub.dev/google/efficientnet/b5/classification/1")
...
`height` x `width` = 456 x 456 pixels for this model. The input
