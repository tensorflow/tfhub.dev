# Module tensorflow/retinanet/resnet101_v1_fpn_640x640/1

Retinanet (SSD with Resnet 101 v1) Object detection model, trained on COCO 2017
dataset with trainning images scaled to 640x640.
...
[COCO 2017](https://cocodataset.org/) dataset (images scaled to 640x640
resolution).
...
detector = hub.load("https://tfhub.dev/tensorflow/retinanet/resnet101_v1_fpn_640x640/1")
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 35.6  | Boxes
