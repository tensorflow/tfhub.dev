# Module tensorflow/small_bert/bert_en_uncased_L-2_H-768_A-12/1
Smaller BERT model.
...
It uses L=2 hidden layers (i.e., Transformer blocks), a hidden size of H=768,
...
The intermediate activations of all L=2
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-2_H-768_A-12/1")
