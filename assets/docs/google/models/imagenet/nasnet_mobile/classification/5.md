# Module google/imagenet/nasnet_mobile/classification/5
...
feature vectors, use
[`google/imagenet/nasnet_mobile/feature_vector/5`](https://tfhub.dev/google/imagenet/nasnet_mobile/feature_vector/5)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/nasnet_mobile/classification/5")
])
