# Module google/imagenet/nasnet_large/feature_vector/5
...
trained for, use
[`google/imagenet/nasnet_large/classification/5`](https://tfhub.dev/google/imagenet/nasnet_large/classification/5)
instead.
