# Module google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/2
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet1k_s/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/classification/2)
instead.
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/2", trainable=True)
```
