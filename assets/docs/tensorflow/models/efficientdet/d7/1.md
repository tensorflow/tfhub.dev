# Module tensorflow/efficientdet/d7/1

EfficientDet Object detection model (SSD with EfficientNet-b7 + BiFPN feature
...
SSD with EfficientNet-b7 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d7). See
...
EfficientNet-b7 checkpoint. Model created using the
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 51.2  | Boxes
