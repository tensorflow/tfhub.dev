# Module tensorflow/small_bert/bert_en_uncased_L-12_H-512_A-8/2
Smaller BERT model.
...
It uses L=12 hidden layers (i.e., Transformer blocks), a hidden size of H=512,
...
encoder = hub.load("https://tfhub.dev/tensorflow/small_bert/bert_en_uncased_L-12_H-512_A-8/2")
