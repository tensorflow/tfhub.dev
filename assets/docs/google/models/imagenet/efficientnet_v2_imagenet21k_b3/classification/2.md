# Module google/imagenet/efficientnet_v2_imagenet21k_b3/classification/2

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2
with input size 300x300.
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_b3/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_b3/feature_vector/2)
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_b3/classification/2", trainable=True)
```
