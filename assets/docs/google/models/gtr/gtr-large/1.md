...
the Text-To-Text Transfer Transformer). The GTR-Large model employs a 24-layer
transformer architecture, which is the same as the T5 large model. The model is
...
Dataset \ Model  | [GTR-Base](https://tfhub.dev/google/gtr/gtr-base/1) | **GTR-Large** | [GTR-XL](https://tfhub.dev/google/gtr/gtr-xl/1) | [GTR-XXL](https://tfhub.dev/google/gtr/gtr-xxl/1)
---------------- | ------------ | ----------------------------------------------------- | ----------------------------------------------- | -------------------------------------------------
...
hub_url = "https://tfhub.dev/google/gtr/gtr-large/1"
