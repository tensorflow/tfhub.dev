...
MLP-Mixer feature extractor fine-tuned on ImageNet-1k.
...
This model is an MLP-Mixer of type L-16 [1] fine-tuned on the ImageNet-1k dataset [2]. This is suitable for fine-tuning.
