# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;woody_plant/1
BiT-m R50x1 fine-tuned on the ImageNet "woody_plant" subtree.
...
on the subtree "woody_plant" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/woody_plant/1")
...
This model was further trained on the "woody_plant" subtree of Imagenet and
