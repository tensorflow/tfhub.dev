# Module sayakpaul/maxim_s-2_deraining_raindrop/1

MAXIM model pre-trained on the raindrop suitable for image deraining.

<!-- asset-path: https://storage.googleapis.com/maxim-tf/tars/S-2_deraining_raindrop.tar.gz  -->
...
This model is based on the MAXIM backbone [1] pre-trained on the raindrop. You can use this
