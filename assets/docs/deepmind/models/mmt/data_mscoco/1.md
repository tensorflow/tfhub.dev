# Module deepmind/mmt/data_mscoco/1
...
This model is our `data_mscoco` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data_mscoco/1')
```
