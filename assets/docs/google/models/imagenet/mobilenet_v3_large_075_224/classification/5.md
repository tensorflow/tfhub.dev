# Module google/imagenet/mobilenet_v3_large_075_224/classification/5

Imagenet (ILSVRC-2012-CLS) classification with MobileNet V3 large (depth multiplier 0.75).
...
as a large network with a depth multiplier of 0.75.
...
The checkpoint exported into this model was `v3-large_224_0.75_float/ema/model-220000` downloaded
from
...
Integrated to [Huggingface Spaces](https://huggingface.co/spaces) with [Gradio](https://github.com/gradio-app/gradio). Try out the Web Demo: [![Hugging Face Spaces](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Spaces-blue)](https://huggingface.co/spaces/tensorflow/mobilenet_v3_large_075_224)
