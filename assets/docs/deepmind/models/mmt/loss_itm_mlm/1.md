# Module deepmind/mmt/loss_itm_mlm/1
...
This model is our `loss_itm_mlm` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/loss_itm_mlm/1')
```
