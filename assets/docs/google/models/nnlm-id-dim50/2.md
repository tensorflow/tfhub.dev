# Module google/&zwnj;nnlm-id-dim50/2
...
embed = hub.load("https://tfhub.dev/google/nnlm-id-dim50/2")
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/nnlm-id-dim50/2",
