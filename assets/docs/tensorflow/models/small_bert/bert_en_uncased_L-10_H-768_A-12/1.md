# Module tensorflow/small_bert/bert_en_uncased_L-10_H-768_A-12/1
Smaller BERT model.
...
It uses L=10 hidden layers (i.e., Transformer blocks),
...
[https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/2](https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/2)
...
The [preprocessor documentation](https://tfhub.dev/tensorflow/bert_en_uncased_preprocess/2)
