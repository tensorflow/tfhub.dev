# Module deepmind/mmt/architecture_image-q-12/1
...
This model is our `architecture_image-q-12` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_image-q-12/1')
```
