# Module google/LAReQA/mBERT_X_X_mono/1
...
This is the X-X-mono baseline model from the
...
always translated to the same language, and each training batch only covers a
single language.
...
loaded = hub.load("https://tfhub.dev/google/LAReQA/mBERT_X_X_mono/1")
