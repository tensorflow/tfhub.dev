# Module tensorflow/faster_rcnn/resnet50_v1_1024x1024/1

Faster R-CNN with Resnet-50 V1 Object detection model, trained on COCO 2017
...
Faster R-CNN with Resnet-50 (v1) initialized from Imagenet classification
checkpoint. Trained on [COCO 2017](https://cocodataset.org/) dataset (images
scaled to 1024x1024 resolution).
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 31.0  | Boxes
