# Module deepmind/mmt/baseline-ft_baseline/1
...
This model is our `baseline-ft_baseline` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/baseline-ft_baseline/1')
```
