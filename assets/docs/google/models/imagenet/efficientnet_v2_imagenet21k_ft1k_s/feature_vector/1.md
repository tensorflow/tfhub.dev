# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/1

Feature vectors of images with EfficientNet V2 with input size 384x384, trained on imagenet-21k (Full ImageNet, Fall 2011 release). Fine-tuned on ImageNet1K.
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/classification/1)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/1",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_s/feature_vector/1", trainable=True)
```
