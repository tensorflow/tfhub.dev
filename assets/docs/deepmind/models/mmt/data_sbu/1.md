# Module deepmind/mmt/data_sbu/1
...
This model is our `data_sbu` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/data_sbu/1')
```
