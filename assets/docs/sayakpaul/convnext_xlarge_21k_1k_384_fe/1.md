# Module sayakpaul/convnext_xlarge_21k_1k_384_fe/1

ConvNeXt model pre-trained on the ImageNet-21k dataset and was then fine-tuned on the ImageNet-1k dataset.

<!-- asset-path: https://storage.googleapis.com/convnext/saved_models/tars/convnext_xlarge_21k_1k_384_fe.tar.gz  -->
