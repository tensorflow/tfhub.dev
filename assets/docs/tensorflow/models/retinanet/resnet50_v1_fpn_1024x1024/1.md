# Module tensorflow/retinanet/resnet50_v1_fpn_1024x1024/1

Retinanet (SSD with Resnet 50 v1) Object detection model, trained on COCO 2017
...
SSD with Resnet 50 v1 FPN feature extractor, shared box predictor and focal loss
(a.k.a Retinanet) and initialized from Imagenet classification checkpoint. See
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 38.3  | Boxes
