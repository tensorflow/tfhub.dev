# Module google/edgetpu/vision/mobilenet-edgetpu-v2-feature-vector/s/2
...
The small version (S) model contains 6.4M parameters. For ImageNet1K dataset,
the model achieves **77.36% top-1 accuracy** with **1.03 ms** latency running on
Pixel 6
...
[here](https://tfhub.dev/google/edgetpu/vision/mobilenet-edgetpu-v2/s/1).
...
hub_layer = hub.KerasLayer(
    'https://tfhub.dev/google/edgetpu/vision/mobilenet-edgetpu-v2-feature-vector/s/2',
    trainable=False)
