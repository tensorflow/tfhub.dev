# Module google/experts/bert/wiki_books/qnli/1
...
https://tfhub.dev/google/experts/bert/wiki_books/1 and fine-tuned on QNLI[5] and
was exported from code in the
...
# Load the BERT model
bert = hub.load('https://tfhub.dev/google/experts/bert/wiki_books/qnli/1')
