# Module google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/1

Feature vectors of images with EfficientNet V2 with input size 480x480, trained on imagenet-21k (Full ImageNet, Fall 2011 release). 
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_m/classification/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/classification/1)
instead.


## Training

The checkpoint exported into this model was `EffNetV2-M for ImageNet21k` downloaded
from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/1",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_m/feature_vector/1", trainable=True)
```
