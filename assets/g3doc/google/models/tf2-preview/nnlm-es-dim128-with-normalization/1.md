# Module google/&zwnj;tf2-preview/&zwnj;nnlm-es-dim128-with-normalization/1
...
TF2.0 functionalities. It is based on [https://tfhub.dev/google/nnlm-es-dim128/1](https://tfhub.dev/google/nnlm-es-dim128/1).
...
```
hub_layer = hub.KerasLayer("https://tfhub.dev/google/tf2-preview/nnlm-es-dim128-with-normalization/1", output_shape=[128], 
