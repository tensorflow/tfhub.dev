# Module tensorflow/efficientdet/d0/1

EfficientDet Object detection model (SSD with EfficientNet-b0 + BiFPN feature
...
SSD with EfficientNet-b0 + BiFPN feature extractor, shared box predictor and
focal loss (a.k.a EfficientDet-d0). See
...
EfficientNet-b0 checkpoint. Model created using the
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 33.6  | Boxes
