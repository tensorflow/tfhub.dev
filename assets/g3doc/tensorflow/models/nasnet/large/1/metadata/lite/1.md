# Lite tensorflow/nasnet/large/1/metadata/1
TF Lite deployment of tensorflow/nasnet/large/1.

<!-- parent-model: tensorflow/nasnet/large/1 -->
...
Image data: `ByteBuffer` sized `331 x 331 x 3 x PIXEL_DEPTH`, where
...
final int IMAGE_SIZE_X = 331;
final int IMAGE_SIZE_Y = 331;
