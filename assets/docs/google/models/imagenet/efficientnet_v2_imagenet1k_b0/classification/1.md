# Module google/imagenet/efficientnet_v2_imagenet1k_b0/classification/1

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet V2 with input size 224x224. 
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_b0/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b0/feature_vector/1)
instead, and save the space occupied by the classification layer.


## Training

The checkpoint exported into this model was `EffNetV2-B0 for ImageNet1k` downloaded
from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b0/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b0/classification/1", trainable=True)
```
