# Module google/HRNet/ade20k-hrnetv2-w48/1

HRNet based model trained on the semantic segmentation dataset ADE20k [4].
...
model = hub.load('https://tfhub.dev/google/HRNet/ade20k-hrnetv2-w48/1')
...
[4] Zhou, B., Zhao, H., Puig, X., Fidler, S., Barriuso, A., Torralba, A.: Scene parsing
