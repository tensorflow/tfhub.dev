...
*   `prediction:logits`: A vector of 99424 similarity scores, corresponding to
    items in the
    ...
    in English, for example, "Xcaret Park". Each landmark may appear in the
    labelmap multiple times; there are 18326 unique labels. Because the output
