# Module sayakpaul/mixer_b16_i1k_classification/1
...
This model is an MLP-Mixer of type B-16 [1] pre-trained on the ImageNet-21k dataset [2] and fine-tuned
on the ImageNet-1k dataset [2]. Other models can be found from the [collection page](https://tfhub.dev/sayakpaul/collections/mlp-mixer/1).
