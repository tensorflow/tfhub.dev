# Lite google/movenet/singlepose/thunder/tflite/float16/4

A TF Lite format (quantized to float16) of google/movenet/singlepose/thunder/4.
Choose this format if you want to deploy the model on device using CPU/GPU.
