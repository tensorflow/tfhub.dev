# Module google/imagenet/efficientnet_v2_imagenet1k_m/classification/2
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_m/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_m/feature_vector/2)
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_m/classification/2", trainable=True)
```
