...
https://tfhub.dev/google/experts/bert/wiki_books/1 and fine-tuned on SST-2[5]
and was exported from code in the
...
The training was done using the `run_classifier.py` script from the
