# Module sayakpaul/maxim_s-2_enhancement_fivek/1

MAXIM model pre-trained on the fivek suitable for image enhancement.

<!-- asset-path: https://storage.googleapis.com/maxim-tf/tars/S-2_enhancement_fivek.tar.gz  -->
...
This model is based on the MAXIM backbone [1] pre-trained on the fivek. You can use this
model for image enhancement (retouching). Please refer to the Colab Notebook linked on this page for more details.
