# Module sayakpaul/maxim_s-3_deblurring_realblur_r/1

MAXIM model pre-trained on the realblur_r suitable for image deblurring.

<!-- asset-path: https://storage.googleapis.com/maxim-tf/tars/S-3_deblurring_realblur_r.tar.gz  -->
...
This model is based on the MAXIM backbone [1] pre-trained on the realblur_r. You can use this
