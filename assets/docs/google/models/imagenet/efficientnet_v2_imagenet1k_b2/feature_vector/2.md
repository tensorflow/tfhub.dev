# Module google/imagenet/efficientnet_v2_imagenet1k_b2/feature_vector/2

Feature vectors of images with EfficientNet V2 with input size 260x260, trained
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet1k_b2/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/classification/2)
instead.

## Training

The checkpoint exported into this model was `EffNetV2-B2 for ImageNet1k`
downloaded from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/feature_vector/2",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b2/feature_vector/2", trainable=True)
```
