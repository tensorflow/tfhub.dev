# Module sayakpaul/maxim_s-3_deblurring_realblur_j/1

MAXIM model pre-trained on the realblur_j suitable for image deblurring.

<!-- asset-path: https://storage.googleapis.com/maxim-tf/tars/S-3_deblurring_realblur_j.tar.gz  -->
...
This model is based on the MAXIM backbone [1] pre-trained on the realblur_j. You can use this
