# Module google/imagenet/efficientnet_v2_imagenet1k_b3/feature_vector/1

Feature vectors of images with EfficientNet V2 with input size 300x300, trained on imagenet-ilsvrc-2012-cls (ILSVRC-2012-CLS). 
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet1k_b3/classification/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/classification/1)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/feature_vector/1",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/feature_vector/1", trainable=True)
```
