# Module google/edgetpu/vision/mobilenet-edgetpu-v2/tiny/1
...
The tiny version (tiny) model contains 3.8M parameters, achieves **74.70% top-1
accuracy** with **1017 FPS** running on Pixel 6
