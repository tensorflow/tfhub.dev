# Module google/imagenet/pnasnet_large/classification/5
...
feature vectors, use
[`google/imagenet/pnasnet_large/feature_vector/5`](https://tfhub.dev/google/imagenet/pnasnet_large/feature_vector/5)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/pnasnet_large/classification/5")
])
