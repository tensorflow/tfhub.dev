# Module google/imagenet/efficientnet_v2_imagenet21k_l/classification/2
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_l/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/feature_vector/2)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/classification/2")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_l/classification/2", trainable=True)
```
