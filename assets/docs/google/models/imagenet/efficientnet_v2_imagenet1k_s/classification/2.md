# Module google/imagenet/efficientnet_v2_imagenet1k_s/classification/2
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/feature_vector/2)
instead, and save the space occupied by the classification layer.

## Training

The checkpoint exported into this model was `EffNetV2-S for ImageNet1k`
downloaded from
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_s/classification/2", trainable=True)
```
