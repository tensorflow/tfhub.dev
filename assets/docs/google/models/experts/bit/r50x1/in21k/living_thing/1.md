# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;living_thing/1
BiT-m R50x1 fine-tuned on the ImageNet "living_thing" subtree.
...
on the subtree "living_thing" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/living_thing/1")
...
This model was further trained on the "living_thing" subtree of Imagenet and
