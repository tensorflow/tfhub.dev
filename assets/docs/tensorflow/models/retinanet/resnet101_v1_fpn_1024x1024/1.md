# Module tensorflow/retinanet/resnet101_v1_fpn_1024x1024/1

Retinanet (SSD with Resnet 101 v1) Object detection model, trained on COCO 2017
dataset with trainning images scaled to 1024x1024.

<!-- asset-path: internal -->
<!-- module-type: image-object-detection -->
<!-- fine-tunable: false -->
<!-- format: saved_model_2 -->
<!-- network-architecture: retinanet -->
<!-- dataset: coco-2017 -->
...
loss (a.k.a Retinanet) and initialized from Imagenet classification checkpoint.
See [Lin et al](https://arxiv.org/abs/1708.02002). Trained on
[COCO 2017](https://cocodataset.org/) dataset (images scaled to 1024x1024
resolution).
...
detector = hub.load("https://tfhub.dev/tensorflow/retinanet/resnet101_v1_fpn_1024x1024/1")
...
------------------------- | ----- | -------
mAP on COCO 2017 test set | 39.5  | Boxes
