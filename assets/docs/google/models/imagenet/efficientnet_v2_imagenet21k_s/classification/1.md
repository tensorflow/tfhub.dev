# Module google/imagenet/efficientnet_v2_imagenet21k_s/classification/1

Imagenet (Full ImageNet, Fall 2011 release) classification with EfficientNet V2 with input size 384x384. 
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_s/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_s/feature_vector/1)
instead, and save the space occupied by the classification layer.


## Training

The checkpoint exported into this model was `EffNetV2-S for ImageNet21k` downloaded
from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_s/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_s/classification/1", trainable=True)
```
