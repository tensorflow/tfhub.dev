# Module google/wiki40b-lm-en/1
Embeddings and negative log likelihood from a language model
trained on English from Wiki40B dataset with sentence-piece
vocabulary size 32k.
...
This specific module is trained on English available in Wiki40B dataset.
It is trained using a 12 layers Transformer XL model [2]. The input to the
module is variable length text in English, and the output is a 768
