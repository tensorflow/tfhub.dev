# Module deepmind/mmt/architecture_heads1-768/1
...
This model is our `architecture_heads1-768` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_heads1-768/1')
```
