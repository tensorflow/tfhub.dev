# Module deepmind/mmt/architecture_single-modality-hloss/1
...
This model is our `architecture_single-modality-hloss` model. Please see the table below for details on
...
m =
hub.Module('https://tfhub.dev/deepmind/mmt/architecture_single-modality-hloss/1')
```
