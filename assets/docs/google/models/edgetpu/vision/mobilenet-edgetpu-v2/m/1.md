# Module google/edgetpu/vision/mobilenet-edgetpu-v2/m/1
...
The medium version (M) model contains 8.9M parameters, achieves **78.43% top-1
accuracy** with **1.35 ms** latency running on Pixel 6
...
keras_layer =
hub.KerasLayer('https://tfhub.dev/google/edgetpu/vision/mobilenet-edgetpu-v2/m/1')
