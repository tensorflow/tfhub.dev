# Module google/bit/m-r50x3/1

Feature vector extraction with the BiT-M R50x3 model.
...
```python
module = hub.KerasLayer("https://tfhub.dev/google/bit/m-r50x3/1")
...
[a specific model](https://tfhub.dev/google/bit/m-r50x3/imagenet21k_classification/1)
for that.
