# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_m/classification/1
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_m/feature_vector/1`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_m/feature_vector/1)
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_m/classification/1")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_m/classification/1", trainable=True)
```
