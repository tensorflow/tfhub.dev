# Module google/&zwnj;experts/&zwnj;bit/&zwnj;r50x1/&zwnj;in21k/&zwnj;covering/1
BiT-m R50x1 fine-tuned on the ImageNet "covering" subtree.
...
on the subtree "covering" of the "Full ImageNet, Fall 2011 release" dataset.


## Usage

```python
module = hub.KerasLayer("https://tfhub.dev/google/experts/bit/r50x1/in21k/covering/1")
...
This model was further trained on the "covering" subtree of Imagenet and
