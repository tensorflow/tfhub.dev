# Module google/imagenet/efficientnet_v2_imagenet21k_ft1k_xl/feature_vector/2

Feature vectors of images with EfficientNet V2 with input size 512x512, trained
on imagenet-21k (Full ImageNet, Fall 2011 release). Fine-tuned on ImageNet1K.
...
trained for, use
[`google/imagenet/efficientnet_v2_imagenet21k_ft1k_xl/classification/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_xl/classification/2)
instead.
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_xl/feature_vector/2",
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet21k_ft1k_xl/feature_vector/2", trainable=True)
```
