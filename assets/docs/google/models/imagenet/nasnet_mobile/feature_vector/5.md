# Module google/imagenet/nasnet_mobile/feature_vector/5
...
trained for, use
[`google/imagenet/nasnet_mobile/classification/5`](https://tfhub.dev/google/imagenet/nasnet_mobile/classification/5)
instead.
