# Module google/imagenet/efficientnet_v2_imagenet1k_b3/classification/2

Imagenet (ILSVRC-2012-CLS) classification with EfficientNet V2 with input size
300x300.
...
feature vectors, use
[`google/imagenet/efficientnet_v2_imagenet1k_b3/feature_vector/2`](https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/feature_vector/2)
instead, and save the space occupied by the classification layer.

## Training

The checkpoint exported into this model was `EffNetV2-B3 for ImageNet1k`
downloaded from
...
m = tf.keras.Sequential([
    hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/classification/2")
])
...
```python
hub.KerasLayer("https://tfhub.dev/google/imagenet/efficientnet_v2_imagenet1k_b3/classification/2", trainable=True)
```
