...
[![Open Demo]](https://storage.googleapis.com/tfjs-models/demos/pose-detection/index.html?model=movenet&&type=thunder)
...
```javascript
tf.loadGraphModel("https://tfhub.dev/google/movenet/singlepose/thunder/tfjs/3", { fromTFHub: true });
```
